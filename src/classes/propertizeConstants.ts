export class PropertizeConstants {
  ...
  public static readonly dataSrcLabel: string = "Data Source";
  public static readonly entityLabel: string = "Entity";
  public static readonly attributeLabel: string = "Attribute";
  public static readonly dataTypeLabel: string = "Data type";
  public static readonly sampleValueLabel: string = "Sample value";
